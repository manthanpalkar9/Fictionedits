      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            In today's creator economy, content quality defines success. We specialize in transforming 
            raw footage into high-retention, platform-optimized short-form content that captures attention 
            and drives engagement. Our editing style combines cutting-edge trends with proven retention 
            strategies, ensuring your content stands out in crowded feeds.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12">
            {[
              { number: "100+", label: "Clients Served" },
              { number: "5000+", label: "Videos Edited" },
              ...
              >
                <div className="text-4xl md:text-5xl font-bold text-glow mb-2">{stat.number}</div>
