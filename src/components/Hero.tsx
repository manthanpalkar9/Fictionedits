  ...
  return (
    <section className="relative py-32 flex items-center justify-center font-helvetica overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-[99999]">
        ...
        <Floating>
          <div className="pointer-events-auto absolute left-10 top-[80%] glass-card p-5 rounded-xl border border-primary/40 shadow-[0_0_20px_rgba(168,85,247,0.35)]">
        ...
        <Floating>
          <div className="pointer-events-auto absolute left-10 bottom-[40%] glass-card p-5 rounded-xl border border-primary/40 shadow-[0_0_20px_rgba(168,85,247,0.35)]">
